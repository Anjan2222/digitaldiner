...
import {  addMenuReview, createMenuItem, deleteMenuItem, getMenuById, getMenuItem, getMenuReviews, updateItemToVeg, updateMenuItem} from "../controllers/menu.controllers.js"
...
router.route("/:resid/menu/:itemid").patch(verifyJWT, authRole, updateItemToVeg)
